...
/*
 * 2002-Oct-3, Michal Necasek: Modified to support OS/2.
 */
...
extern void APIENTRY gluNurbsCallback (GLUnurbs* nurb, GLenum which, GLvoid (* APIENTRY CallBackFunc)());
...
extern void APIENTRY gluQuadricCallback (GLUquadric* quad, GLenum which, GLvoid (* APIENTRY CallBackFunc)());
...
extern void APIENTRY gluTessCallback (GLUtesselator* tess, GLenum which, GLvoid (* APIENTRY CallBackFunc)());
