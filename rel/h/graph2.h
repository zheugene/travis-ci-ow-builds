...
/* Truecolor related extensions */

_WCRTLINK extern grcolor
    _WCI86FAR _rgb2pixel(unsigned char r, unsigned char g, unsigned char b);
_WCRTLINK extern void
    _WCI86FAR _pixel2rgb(unsigned char *r, unsigned char *g, unsigned char *b, grcolor pix);
...
extern grcolor          _coltbl[ 16 ];

#define _BLACK          _coltbl[0]
#define _BLUE           _coltbl[1]
#define _GREEN          _coltbl[2]
#define _CYAN           _coltbl[3]
#define _RED            _coltbl[4]
#define _MAGENTA        _coltbl[5]
#define _BROWN          _coltbl[6]
#define _WHITE          _coltbl[7]
#define _GRAY           _coltbl[8]
#define _LIGHTBLUE      _coltbl[9]
#define _LIGHTGREEN     _coltbl[10]
#define _LIGHTCYAN      _coltbl[11]
#define _LIGHTRED       _coltbl[12]
#define _LIGHTMAGENTA   _coltbl[13]
#define _YELLOW         _coltbl[14]
#define _BRIGHTWHITE    _coltbl[15]
#define _LIGHTYELLOW    _coltbl[14]
