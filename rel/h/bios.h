...
_WCRTLINK extern unsigned short _bios_printer(unsigned __cmd,unsigned __port, unsigned __data);
_WCRTLINK extern unsigned short _bios_serialcom(unsigned __cmd,unsigned __port, unsigned __data);
