...
/* GUIDs */
EXTERN_C const IID      __cdecl LIBID_Shell32;
EXTERN_C const IID      __cdecl IID_IFolderViewOC;
EXTERN_C const IID      __cdecl DIID_DShellFolderViewEvents;
EXTERN_C const CLSID    __cdecl CLSID_ShellFolderViewOC;
EXTERN_C const IID      __cdecl IID_DFConstraint;
EXTERN_C const IID      __cdecl IID_Folder;
EXTERN_C const IID      __cdecl IID_Folder2;
EXTERN_C const IID      __cdecl IID_Folder3;
EXTERN_C const IID      __cdecl IID_FolderItem;
EXTERN_C const IID      __cdecl IID_FolderItem2;
EXTERN_C const CLSID    __cdecl CLSID_ShellFolderItem;
EXTERN_C const IID      __cdecl IID_FolderItems;
EXTERN_C const IID      __cdecl IID_FolderItems2;
EXTERN_C const IID      __cdecl IID_FolderItems3;
EXTERN_C const IID      __cdecl IID_FolderItemVerb;
EXTERN_C const IID      __cdecl IID_FolderItemVerbs;
EXTERN_C const IID      __cdecl IID_IShellLinkDual;
EXTERN_C const IID      __cdecl IID_IShellLinkDual2;
EXTERN_C const CLSID    __cdecl CLSID_ShellLinkObject;
EXTERN_C const IID      __cdecl IID_IShellFolderViewDual;
EXTERN_C const IID      __cdecl IID_IShellFolderViewDual2;
EXTERN_C const IID      __cdecl IID_IShellFolderViewDual3;
EXTERN_C const CLSID    __cdecl CLSID_ShellFolderView;
EXTERN_C const IID      __cdecl IID_IShellDispatch;
EXTERN_C const IID      __cdecl IID_IShellDispatch2;
EXTERN_C const IID      __cdecl IID_IShellDispatch3;
EXTERN_C const IID      __cdecl IID_IShellDispatch4;
EXTERN_C const IID      __cdecl IID_IShellDispatch5;
EXTERN_C const CLSID    __cdecl CLSID_Shell;
EXTERN_C const CLSID    __cdecl CLSID_ShellDispatchInproc;
EXTERN_C const IID      __cdecl IID_IFileSearchBand;
EXTERN_C const CLSID    __cdecl CLSID_FileSearchBand;
EXTERN_C const IID      __cdecl IID_IWebWizardHost;
EXTERN_C const IID      __cdecl IID_INewWDEvents;
EXTERN_C const IID      __cdecl IID_IAutoComplete;
EXTERN_C const IID      __cdecl IID_IAutoComplete2;
EXTERN_C const IID      __cdecl IID_IEnumACString;
EXTERN_C const IID      __cdecl IID_IAsyncOperation;
