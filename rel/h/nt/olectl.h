...
/* GUIDs */
EXTERN_C const IID      __cdecl IID_IPropertyFrame;
EXTERN_C const CLSID    __cdecl CLSID_CFontPropPage;
EXTERN_C const CLSID    __cdecl CLSID_CColorPropPage;
EXTERN_C const CLSID    __cdecl CLSID_CPicturePropPage;
EXTERN_C const CLSID    __cdecl CLSID_PersistPropset;
EXTERN_C const CLSID    __cdecl CLSID_ConvertVBX;
EXTERN_C const CLSID    __cdecl CLSID_StdFont;
EXTERN_C const CLSID    __cdecl CLSID_StdPicture;
EXTERN_C const GUID     __cdecl GUID_HIMETRIC;
EXTERN_C const GUID     __cdecl GUID_COLOR;
EXTERN_C const GUID     __cdecl GUID_XPOSPIXEL;
EXTERN_C const GUID     __cdecl GUID_YPOSPIXEL;
EXTERN_C const GUID     __cdecl GUID_XSIZEPIXEL;
EXTERN_C const GUID     __cdecl GUID_YSIZEPIXEL;
EXTERN_C const GUID     __cdecl GUID_XPOS;
EXTERN_C const GUID     __cdecl GUID_YPOS;
EXTERN_C const GUID     __cdecl GUID_XSIZE;
EXTERN_C const GUID     __cdecl GUID_YSIZE;
#ifndef __CGUID_H__
EXTERN_C const GUID     __cdecl GUID_TRISTATE;
#endif
EXTERN_C const GUID     __cdecl GUID_OPTIONVALUEEXCLUSIVE;
EXTERN_C const GUID     __cdecl GUID_CHECKVALUEEXCLUSIVE;
EXTERN_C const GUID     __cdecl GUID_FONTNAME;
EXTERN_C const GUID     __cdecl GUID_FONTSIZE;
EXTERN_C const GUID     __cdecl GUID_FONTBOLD;
EXTERN_C const GUID     __cdecl GUID_FONTITALIC;
EXTERN_C const GUID     __cdecl GUID_FONTUNDERSCORE;
EXTERN_C const GUID     __cdecl GUID_FONTSTRIKETHROUGH;
EXTERN_C const GUID     __cdecl GUID_HANDLE;
