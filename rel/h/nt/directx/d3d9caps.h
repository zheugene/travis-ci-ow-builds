...
/* GUIDs */
EXTERN_C const GUID __cdecl D3DCRYPTOTYPE_AES128_CTR;
EXTERN_C const GUID __cdecl D3DCRYPTOTYPE_PROPRIETARY;
EXTERN_C const GUID __cdecl D3DKEYEXCHANGE_RSAES_OAEP;
EXTERN_C const GUID __cdecl D3DKEYEXCHANGE_DXVA;
