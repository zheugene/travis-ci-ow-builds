...
/* Notification class event flags */
#define NOTIFICATION_NO_CLASS_EVENTS                    0x00
#define NOTIFICATION_OPERATIONAL_CHANGE_CLASS_EVENTS    0x01
#define NOTIFICATION_POWER_MANAGEMENT_CLASS_EVENTS      0x02
#define NOTIFICATION_EXTERNAL_REQUEST_CLASS_EVENTS      0x03
#define NOTIFICATION_MEDIA_STATUS_CLASS_EVENTS          0x04
#define NOTIFICATION_MULTI_HOST_CLASS_EVENTS            0x05
#define NOTIFICATION_DEVICE_BUSY_CLASS_EVENTS           0x06

/* Notification operational events */
#define NOTIFICATION_OPERATIONAL_EVENT_NO_CHANGE        0x00
#define NOTIFICATION_OPERATIONAL_EVENT_CHANGE_REQUESTED 0x01
#define NOTIFICATION_OPERATIONAL_EVENT_CHANGE_OCCURRED  0x02

/* Notification operational status values */
#define NOTIFICATION_OPERATIONAL_STATUS_AVAILABLE       0x00
#define NOTIFICATION_OPERATIONAL_STATUS_TEMPORARY_BUSY  0x01
#define NOTIFICATION_OPERATIONAL_STATUS_EXTENDED_BUSY   0x02

/* Notification operational operation codes */
#define NOTIFICATION_OPERATIONAL_OPCODE_NONE                0x00
#define NOTIFICATION_OPERATIONAL_OPCODE_FEATURE_CHANGE      0x01
#define NOTIFICATION_OPERATIONAL_OPCODE_FEATURE_ADDED       0x02
#define NOTIFICATION_OPERATIONAL_OPCODE_UNIT_RESET          0x03
#define NOTIFICATION_OPERATIONAL_OPCODE_FIRMWARE_CHANGED    0x04
#define NOTIFICATION_OPERATIONAL_OPCODE_INQUIRY_CHANGED     0x05

/* Notification power events */
#define NOTIFICATION_POWER_EVENT_NO_CHANGE          0x00
#define NOTIFICATION_POWER_EVENT_CHANGE_SUCCEEDED   0x01
#define NOTIFICATION_POWER_EVENT_CHANGE_FAILED      0x02

/* Notification power status values */
#define NOTIFICATION_POWER_STATUS_ACTIVE    0x01
#define NOTIFICATION_POWER_STATUS_IDLE      0x02
#define NOTIFICATION_POWER_STATUS_STANDBY   0x03
#define NOTIFICATION_POWER_STATUS_SLEEP     0x04

/* Notification external events */
#define NOTIFICATION_MEDIA_EVENT_NO_EVENT       0x00
#define NOTIFICATION_EXTERNAL_EVENT_NO_CHANGE   0x00
#define NOTIFICATION_EXTERNAL_EVENT_BUTTON_DOWN 0x01
#define NOTIFICATION_EXTERNAL_EVENT_BUTTON_UP   0x02
#define NOTIFICATION_EXTERNAL_EVENT_EXTERNAL    0x03

/* Notification external status values */
#define NOTIFICATION_EXTERNAL_STATUS_READY      0x00
#define NOTIFICATION_EXTERNAL_STATUS_PREVENT    0x01

/* Notification external requests */
...
/* Notification media events */
#define NOTIFICATION_MEDIA_EVENT_NO_CHANGE      0x00
#define NOTIFICATION_MEDIA_EVENT_EJECT_REQUEST  0x01
#define NOTIFICATION_MEDIA_EVENT_NEW_MEDIA      0x02
#define NOTIFICATION_MEDIA_EVENT_MEDIA_REMOVAL  0x03
#define NOTIFICATION_MEDIA_EVENT_MEDIA_CHANGE   0x04

/* Notification multi-host events */
#define NOTIFICATION_BUSY_EVENT_NO_EVENT                0x00
#define NOTIFICATION_MULTI_HOST_EVENT_NO_CHANGE         0x00
#define NOTIFICATION_MULTI_HOST_EVENT_CONTROL_REQUEST   0x01
#define NOTIFICATION_MULTI_HOST_EVENT_CONTROL_GRANT     0x02
#define NOTIFICATION_MULTI_HOST_EVENT_CONTROL_RELEASE   0x03

/* Notification multi-host status values */
#define NOTIFICATION_MULTI_HOST_STATUS_READY    0x00
#define NOTIFICATION_MULTI_HOST_STATUS_PREVENT  0x01

/* Notification multi-host priority values */
#define NOTIFICATION_MULTI_HOST_PRIORITY_NO_REQUESTS    0x00
#define NOTIFICATION_MULTI_HOST_PRIORITY_LOW            0x01
#define NOTIFICATION_MULTI_HOST_PRIORITY_MEDIUM         0x02
#define NOTIFICATION_MULTI_HOST_PRIOTITY_HIGH           0x03

/* Notification busy events */
#define NOTIFICATION_BUSY_EVENT_NO_EVENT    0x00
#define NOTIFICATION_BUSY_EVENT_NO_CHANGE   0x00
#define NOTIFICATION_BUSY_EVENT_BUSY        0x01

/* Notification busy status values */
#define NOTIFICATION_BUSY_STATUS_NO_EVENT   0x00
#define NOTIFICATION_BUSY_STATUS_POWER      0x01
#define NOTIFICATION_BUSY_STATUS_IMMEDIATE  0x02
#define NOTIFICATION_BUSY_STATUS_DEFERRED   0x03
...
/* CDVD data structure identifiers */
...
/* Blank type codes */
#define BLANK_FULL              0x00
#define BLANK_MINIMAL           0x01
#define BLANK_TRACK             0x02
#define BLANK_UNRESERVE_TRACK   0x03
#define BLANK_TAIL              0x04
#define BLANK_UNCLOSE_SESSION   0x05
#define BLANK_SESSION           0x06

/* CD expected sector values */
#define CD_EXPECTED_SECTOR_ANY          0x00
#define CD_EXPECTED_SECTOR_CDDA         0x01
#define CD_EXPECTED_SECTOR_MODE1        0x02
#define CD_EXPECTED_SECTOR_MODE2        0x03
#define CD_EXPECTED_SECTOR_MODE2_FORM1  0x04
#define CD_EXPECTED_SECTOR_MODE2_FORM2  0x05
...
/* Disc background format states */
#define DISC_BGFORMAT_STATE_NONE        0x00
#define DISC_BGFORMAT_STATE_INCOMPLETE  0x01
#define DISC_BGFORMAT_STATE_RUNNING     0x02
#define DISC_BGFORMAT_STATE_COMPLETE    0x03

/* Data block modes */
#define DATA_BLOCK_MODE0    0x00
#define DATA_BLOCK_MODE1    0x01
#define DATA_BLOCK_MODE2    0x02
...
/* Common descriptor block lengths */
#define CDB6GENERIC_LENGTH  6
#define CDB10GENERIC_LENGTH 10
#define CDB12GENERIC_LENGTH 12

/* Set bit on/off constants */
#define SETBITON    1
#define SETBITOFF   0
...
#define MODE_PAGE_VERIFY_ERRORS                 0x07
...
/* Common descriptor block return values */
#define CDB_RETURN_ON_COMPLETION    0
#define CDB_RETURN_IMMEDIATE        1

/* Common descriptor block force media access flag */
#define CDB_FORCE_MEDIA_ACCESS  0x08

/* Denon SCSI operation codes */
...
#define SCSIMESS_IGNORE_WITH_RESIDUE    0x23
...
/* Common descriptor block inquiry EVPD flag */
#define CDB_INQUIRY_EVPD    0x01

/* Format common descriptor block constants */
...
/* Vital product data maximum buffer size */
#define VPD_MAX_BUFFER_SIZE 0xFF

/* Vital product data page identifiers */
...
#define SCSI_SENSEQ_COMM_CRC_ERROR                      0x03
...
/* CDDA channels */
#define CDDA_CHANNEL_MUTED  0x00
#define CDDA_CHANNEL_ZERO   0x01
#define CDDA_CHANNEL_ONE    0x02
#define CDDA_CHANNEL_TWO    0x04
#define CDDA_CHANNEL_THREE  0x08

/* CDVD capabilities constants */
...
/* CD-ROM audio control constants */
...
/* There is a constant called _PRINT declared in ctype.h that causes a conflict with
...
/* Notification event status header */
...
typedef NOTIFICATION_EVENT_STATUS_HEADER    *PNOTIFICATION_EVENT_STATUS_HEADER;
...
typedef NOTIFICATION_OPERATIONAL_STATUS *PNOTIFICATION_OPERATIONAL_STATUS;

/* Notification power status */
...
typedef NOTIFICATION_POWER_STATUS   *PNOTIFICATION_POWER_STATUS;

/* Notification external status */
...
typedef NOTIFICATION_EXTERNAL_STATUS    *PNOTIFICATION_EXTERNAL_STATUS;

/* Notification media status */
...
typedef NOTIFICATION_MEDIA_STATUS   *PNOTIFICATION_MEDIA_STATUS;

/* Notification multi-host status */
...
typedef NOTIFICATION_MULTI_HOST_STATUS  *PNOTIFICATION_MULTI_HOST_STATUS;

/* Notification busy status */
...
typedef NOTIFICATION_BUSY_STATUS    *PNOTIFICATION_BUSY_STATUS;

/* Read DVD structures header */
typedef struct _READ_DVD_STRUCTURES_HEADER {
    UCHAR   Length[2];
    UCHAR   Reserved[2];
    UCHAR   Data[1];
} READ_DVD_STRUCTURES_HEADER;
typedef READ_DVD_STRUCTURES_HEADER  *PREAD_DVD_STRUCTURES_HEADER;
...
typedef CDVD_KEY_HEADER *PCDVD_KEY_HEADER;

/* CDVD report AGID data */
typedef struct _CDVD_REPORT_AGID_DATA {
    UCHAR   Reserved1[3];
    UCHAR   Reserved2   : 6;
    UCHAR   AGID        : 2;
} CDVD_REPORT_AGID_DATA;
typedef CDVD_REPORT_AGID_DATA   *PCDVD_REPORT_AGID_DATA;

/* CDVD challenge key data */
typedef struct _CDVD_CHALLENGE_KEY_DATA {
    UCHAR   ChallengeKeyValue[10];
    UCHAR   Reserved[2];
} CDVD_CHALLENGE_KEY_DATA;
typedef CDVD_CHALLENGE_KEY_DATA *PCDVD_CHALLENGE_KEY_DATA;
...
typedef CDVD_KEY_DATA   *PCDVD_KEY_DATA;

/* CDVD report ASF data */
typedef struct _CDVD_REPORT_ASF_DATA {
    UCHAR   Reserved1[3];
    UCHAR   Success     : 1;
    UCHAR   Reserved2   : 7;
} CDVD_REPORT_ASF_DATA;
typedef CDVD_REPORT_ASF_DATA    *PCDVD_REPORT_ASF_DATA;

/* CDVD title key header */
...
typedef CDVD_TITLE_KEY_HEADER   *PCDVD_TITLE_KEY_HEADER;
...
typedef FORMAT_DESCRIPTOR   *PFORMAT_DESCRIPTOR;
...
typedef struct _FORMAT_LIST_HEADER {
    ...
    FORMAT_DESCRIPTOR   Descriptors[1];
} FORMAT_LIST_HEADER;
typedef FORMAT_LIST_HEADER  *PFORMAT_LIST_HEADER;

/* Formatted capacity descriptor */
...
typedef FORMATTED_CAPACITY_DESCRIPTOR   *PFORMATTED_CAPACITY_DESCRIPTOR;

/* Formatted capacity list */
typedef struct _FORMATTED_CAPACITY_LIST {
    UCHAR                           Reserved[3];
    UCHAR                           CapacityListLength;
    FORMATTED_CAPACITY_DESCRIPTOR   Descriptors[1];
} FORMATTED_CAPACITY_LIST;
typedef FORMATTED_CAPACITY_LIST *PFORMATTED_CAPACITY_LIST;
...
typedef OPC_TABLE_ENTRY *POPC_TABLE_ENTRY;
...
typedef DISC_INFORMATION    *PDISC_INFORMATION;
...
typedef DISK_INFORMATION    *PDISK_INFORMATION;
...
typedef DATA_BLOCK_HEADER   *PDATA_BLOCK_HEADER;
...
typedef TRACK_INFORMATION   *PTRACK_INFORMATION;

/* Track information (revision 2) */
...
typedef TRACK_INFORMATION2  *PTRACK_INFORMATION2;

/* Track information (revision 3) */
...
typedef TRACK_INFORMATION3  *PTRACK_INFORMATION3;
...
typedef PERFORMANCE_DESCRIPTOR  *PPERFORMANCE_DESCRIPTOR;

/* SCSI extended message */
...
typedef SCSI_EXTENDED_MESSAGE   *PSCSI_EXTENDED_MESSAGE;
...
typedef INQUIRYDATA *PINQUIRYDATA;

/* Vital product data media serial number page */
...
typedef VPD_MEDIA_SERIAL_NUMBER_PAGE    *PVPD_MEDIA_SERIAL_NUMBER_PAGE;

/* Vital product data serial number page */
...
typedef VPD_SERIAL_NUMBER_PAGE  *PVPD_SERIAL_NUMBER_PAGE;

/* Vital product data code sets */
...
typedef VPD_CODE_SET    *PVPD_CODE_SET;

/* Vital product data associations */
typedef enum _VPD_ASSOCIATION {
    VpdAssocDevice  = 0,
    VpdAssocPort    = 1,
    VpdAssocTarget  = 2
} VPD_ASSOCIATION;
typedef VPD_ASSOCIATION *PVPD_ASSOCIATION;

/* Vital product data identifier types */
...
typedef VPD_IDENTIFIER_TYPE *PVPD_IDENTIFIER_TYPE;

/* Vital product data identification descriptor */
...
/* Vital product data identification page */
...
typedef VPD_IDENTIFICATION_PAGE *PVPD_IDENTIFICATION_PAGE;

/* Vital product data supported pages page */
typedef struct _VPD_SUPPORTED_PAGES_PAGE {
    ...
    UCHAR   Reserved;
    UCHAR   PageLength;
    UCHAR   SupportedPageList[1];
} VPD_SUPPORTED_PAGES_PAGE;
typedef VPD_SUPPORTED_PAGES_PAGE    *PVPD_SUPPORTED_PAGES_PAGE;

/* Registration list */
typedef struct {
    UCHAR   Generation[4];
    UCHAR   AdditionalLength[4];
    UCHAR   ReservationKeyList[1][8];
} PRI_REGISTRATION_LIST;
typedef PRI_REGISTRATION_LIST   *PPRI_REGISTRATION_LIST;
...
typedef PRI_RESERVATION_DESCRIPTOR  *PPRI_RESERVATION_DESCRIPTOR;

/* Reservation list */
typedef struct {
    UCHAR                       Generation[4];
    UCHAR                       AdditionalLength[4];
    PRI_RESERVATION_DESCRIPTOR  Reservations[1];
} PRI_RESERVATION_LIST;
typedef PRI_RESERVATION_LIST    *PPRI_RESERVATION_LIST;
...
typedef PRO_PARAMETER_LIST  *PPRO_PARAMETER_LIST;
...
typedef SENSE_DATA  *PSENSE_DATA;
...
typedef READ_CAPACITY_DATA  *PREAD_CAPACITY_DATA;

/* Read capacity data (extended version) */
typedef struct _READ_CAPACITY_DATA_EX {
    LARGE_INTEGER   LogicalBlockAddress;
    ULONG           BytesPerBlock;
} READ_CAPACITY_DATA_EX;
typedef READ_CAPACITY_DATA_EX   *PREAD_CAPACITY_DATA_EX;
...
typedef READ_BLOCK_LIMITS_DATA  *PREAD_BLOCK_LIMITS_DATA;

/* Read buffer capacity data */
...
typedef READ_BUFFER_CAPACITY_DATA   *PREAD_BUFFER_CAPACITY_DATA;
...
typedef MODE_PARAMETER_HEADER   *PMODE_PARAMETER_HEADER;

/* Mode parameter header (version 10) */
...
typedef MODE_PARAMETER_HEADER10 *PMODE_PARAMETER_HEADER10;
...
typedef MODE_PARAMETER_BLOCK    *PMODE_PARAMETER_BLOCK;

/* Mode disconnect page */
...
typedef MODE_DISCONNECT_PAGE    *PMODE_DISCONNECT_PAGE;
...
typedef MODE_CACHING_PAGE   *PMODE_CACHING_PAGE;

/* Mode CD-ROM write parameters page (version 2) */
...
typedef MODE_CDROM_WRITE_PARAMETERS_PAGE2   *PMODE_CDROM_WRITE_PARAMETERS_PAGE2;

/* Mode CD-ROM write parameters page */
...
typedef MODE_CDROM_WRITE_PARAMETERS_PAGE    *PMODE_CDROM_WRITE_PARAMETERS_PAGE;
...
typedef MODE_MRW_PAGE   *PMODE_MRW_PAGE;
...
typedef MODE_FLEXIBLE_DISK_PAGE *PMODE_FLEXIBLE_DISK_PAGE;
...
typedef MODE_FORMAT_PAGE    *PMODE_FORMAT_PAGE;

/* Mode rigid geometry page */
...
typedef MODE_RIGID_GEOMETRY_PAGE    *PMODE_RIGID_GEOMETRY_PAGE;

/* Mode read/write recovery page */
...
typedef MODE_READ_WRITE_RECOVERY_PAGE   *PMODE_READ_WRITE_RECOVERY_PAGE;

/* Mode read recovery page */
...
typedef MODE_READ_RECOVERY_PAGE *PMODE_READ_RECOVERY_PAGE;

/* Mode information exceptions */
...
typedef MODE_INFO_EXCEPTIONS    *PMODE_INFO_EXCEPTIONS;
...
typedef POWER_CONDITION_PAGE    *PPOWER_CONDITION_PAGE;
...
typedef CDDA_OUTPUT_PORT    *PCDDA_OUTPUT_PORT;
...
typedef CDAUDIO_CONTROL_PAGE    *PCDAUDIO_CONTROL_PAGE;

/* CDVD feature set page */
...
typedef CDVD_FEATURE_SET_PAGE   *PCDVD_FEATURE_SET_PAGE;

/* CDVD inactivity timeout page */
...
typedef CDVD_INACTIVITY_TIMEOUT_PAGE    *PCDVD_INACTIVITY_TIMEOUT_PAGE;

/* CDVD capabilities page */
...
typedef CDVD_CAPABILITIES_PAGE  *PCDVD_CAPABILITIES_PAGE;
...
typedef MODE_PARM_READ_WRITE_DATA   *PMODE_PARM_READ_WRITE_DATA;
...
typedef PORT_OUTPUT *PPORT_OUTPUT;
...
typedef AUDIO_OUTPUT    *PAUDIO_OUTPUT;

/* Mechanical status information header */
...
typedef MECHANICAL_STATUS_INFORMATION_HEADER    *PMECHANICAL_STATUS_INFORMATION_HEADER;

/* Slot table information */
...
typedef SLOT_TABLE_INFORMATION  *PSLOT_TABLE_INFORMATION;
...
typedef MECHANICAL_STATUS   *PMECHANICAL_STATUS;
...
typedef TAPE_POSITION_DATA  *PTAPE_POSITION_DATA;
...
typedef EIGHT_BYTE  *PEIGHT_BYTE;
...
typedef TWO_BYTE    *PTWO_BYTE;

/* Revert to default packing. */
#pragma pack( pop )

/* Byte-reversing macros */
#define REVERSE_BYTES_QUAD( p1, p2 ) \
    { \
        PEIGHT_BYTE v1 = (PEIGHT_BYTE)(p1); \
        PEIGHT_BYTE v2 = (PEIGHT_BYTE)(p2); \
        v1->Byte7 = v2->Byte0; \
        v1->Byte6 = v2->Byte1; \
        v1->Byte5 = v2->Byte2; \
        v1->Byte4 = v2->Byte3; \
...
#define REVERSE_BYTES( p1, p2 ) \
    { \
        PFOUR_BYTE  v1 = (PFOUR_BYTE)(p1); \
        PFOUR_BYTE  v2 = (PFOUR_BYTE)(p2); \
        v1->Byte3 = v2->Byte0; \
        v1->Byte2 = v2->Byte1; \
        v1->Byte1 = v2->Byte2; \
        v1->Byte0 = v2->Byte3; \
    }
#define REVERSE_BYTES_SHORT( p1, p2 ) \
    { \
        PTWO_BYTE   v1 = (PTWO_BYTE)(p1); \
        PTWO_BYTE   v2 = (PTWO_BYTE)(p2); \
        v1->Byte1 = v2->Byte0; \
        v1->Byte0 = v2->Byte1; \
    }
#define REVERSE_SHORT( x ) \
    { \
        UCHAR       v1; \
        PTWO_BYTE   v2 = (PTWO_BYTE)(x); \
        v1 = v2->Byte0; \
        v2->Byte0 = v2->Byte1; \
        v2->Byte1 = v1; \
    }
#define REVERSE_LONG( x ) \
    { \
        UCHAR       v1; \
        PFOUR_BYTE  v2 = (PFOUR_BYTE)(x); \
        v1 = v2->Byte3; \
        v2->Byte3 = v2->Byte0; \
        v2->Byte0 = v1; \
        v1 = v2->Byte2; \
