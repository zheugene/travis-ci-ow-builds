...
#define IOCTL_CDROM_SEND_OPC_INFORMATION \
    CTL_CODE( IOCTL_CDROM_BASE, 0x001B, METHOD_BUFFERED, FILE_READ_ACCESS | \
    FILE_WRITE_ACCESS )
...
/* Streaming control request types */
...
typedef STREAMING_CONTROL_REQUEST_TYPE  *PSTREAMING_CONTROL_REQUEST_TYPE;

/* CD-ROM streaming control */
typedef struct _CDROM_STREAMING_CONTROL {
    STREAMING_CONTROL_REQUEST_TYPE  RequestType;
} CDROM_STREAMING_CONTROL;
typedef CDROM_STREAMING_CONTROL *PCDROM_STREAMING_CONTROL;

/* CD-ROM OPC information types */
typedef enum _CDROM_OPC_INFO_TYPE {
    SimpleOpcInfo   = 1
} CDROM_OPC_INFO_TYPE;
typedef CDROM_OPC_INFO_TYPE *PCDROM_OPC_INFO_TYPE;

/* CD-ROM simple OPC information */
typedef struct _CDROM_SIMPLE_OPC_INFO {
    CDROM_OPC_INFO_TYPE RequestType;
    BOOLEAN             Exclude0;
    BOOLEAN             Exclude1;
} CDROM_SIMPLE_OPC_INFO;
typedef CDROM_SIMPLE_OPC_INFO   *PCDROM_SIMPLE_OPC_INFO;

/* CD-ROM performance request types */
...
typedef CDROM_PERFORMANCE_REQUEST_TYPE  *PCDROM_PERFORMANCE_REQUEST_TYPE;

/* CD-ROM performance types */
typedef enum _CDROM_PERFORMANCE_TYPE {
    CdromReadPerformance    = 1,
    CdromWritePerformance   = 2
} CDROM_PERFORMANCE_TYPE;
typedef CDROM_PERFORMANCE_TYPE  *PCDROM_PERFORMANCE_TYPE;

/* CD-ROM performance exception types */
...
typedef CDROM_PERFORMANCE_EXCEPTION_TYPE    *PCDROM_PERFORMANCE_EXCEPTION_TYPE;

/* CD-ROM performance tolerance types */
typedef enum _CDROM_PERFORMANCE_TOLERANCE_TYPE {
    Cdrom10Nominal20Exceptions  = 1
} CDROM_PERFORMANCE_TOLERANCE_TYPE;
typedef CDROM_PERFORMANCE_TOLERANCE_TYPE    *PCDROM_PERFORMANCE_TOLERANCE_TYPE;

/* CD-ROM performance request */
...
typedef CDROM_PERFORMANCE_REQUEST   *PCDROM_PERFORMANCE_REQUEST;

/* CD-ROM write speed request */
typedef struct _CDROM_WRITE_SPEED_REQUEST {
    CDROM_PERFORMANCE_REQUEST_TYPE  RequestType;
} CDROM_WRITE_SPEED_REQUEST;
typedef CDROM_WRITE_SPEED_REQUEST   *PCDROM_WRITE_SPEED_REQUEST;

/* CD-ROM performance header */
...
typedef CDROM_PERFORMANCE_HEADER    *PCDROM_PERFORMANCE_HEADER;

/* CD-ROM nominal performance descriptor */
...
typedef CDROM_NOMINAL_PERFORMANCE_DESCRIPTOR    *PCDROM_NOMINAL_PERFORMANCE_DESCRIPTOR;

/* CD-ROM exception performance descriptor */
typedef struct _CDROM_EXCEPTION_PERFORMANCE_DESCRIPTOR {
    UCHAR   Lba[4];
    UCHAR   Time[2];
} CDROM_EXCEPTION_PERFORMANCE_DESCRIPTOR;
typedef CDROM_EXCEPTION_PERFORMANCE_DESCRIPTOR  *PCDROM_EXCEPTION_PERFORMANCE_DESCRIPTOR;

/* CD-ROM write speed descriptor */
...
typedef CDROM_WRITE_SPEED_DESCRIPTOR    *PCDROM_WRITE_SPEED_DESCRIPTOR;
