...
_WCRTLINK extern unsigned long int htonl(unsigned long int hostlong);
_WCRTLINK extern unsigned short int htons(unsigned short int hostshort);
_WCRTLINK extern unsigned long int ntohl(unsigned long int netlong);
_WCRTLINK extern unsigned short int ntohs(unsigned short int netshort);
